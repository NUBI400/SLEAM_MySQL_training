...
CREATE TABLE `desenvolvedores` (
  `idDesenvolvedores` int NOT NULL AUTO_INCREMENT,
  `Nome` varchar(100) NOT NULL,
  `Site_oficial` varchar(100) DEFAULT NULL,
  PRIMARY KEY (`idDesenvolvedores`)
...
INSERT INTO `desenvolvedores` VALUES (7,'Valve','https://www.valvesoftware.com'),(8,'CD Projekt Red','https://www.cdprojekt.com'),(9,'Rockstar Games','https://www.rockstargames.com');
